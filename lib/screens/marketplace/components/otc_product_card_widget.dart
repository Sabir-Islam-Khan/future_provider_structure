...
class OtcProductCardWidget extends StatelessWidget {
  final Product product;
  const OtcProductCardWidget({Key? key, required this.product}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final _productPictureUrl = ApiUrl.productPictureLink + product.featurePicture!;
    debugPrint('home_screen selfieFileName: $_productPictureUrl \n\n');
